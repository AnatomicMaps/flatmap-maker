...
* Within this environment, install the devel ``mapmaker`` wheel, https://github.com/dbrnz/flatmap-maker/releases/download/v1.4.2b1/mapmaker-1.4.2b1-py3-none-any.whl.
...
* Install ``mapmaker`` directly from GitHub with::
    ...
    $ pipenv install --python 3.8 https://github.com/dbrnz/flatmap-maker/releases/download/v1.4.2b1/mapmaker-1.4.2b1-py3-none-any.whl
