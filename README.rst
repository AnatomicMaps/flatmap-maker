...
* Within this environment, install the latest ``mapmaker`` wheel from https://github.com/dbrnz/flatmap-maker/releases/latest (currently ``mapmaker-1.4.0a1-py3-none-any.whl``).
...
* Install ``mapmaker`` directly from GitHub with::
    ...
    $ pipenv install --python 3.8 https://github.com/dbrnz/flatmap-maker/releases/download/v1.4.0a1/mapmaker-1.4.0a1-py3-none-any.whl
